...
![Market Mavericks](/images/SCR-20251016-kmtk.png)
...
| Greedy Trader | Maximizes profits in bull markets. | Medium | Long-Term |
| Swing Trader | Captures medium-term swings. | Medium | Medium-Term |
| Balanced Trader | Steady, all-around approach. | Low | Medium-Term |
| Speculative Trader | Bets on volatile opportunities. | Medium | Medium-Term |
| Day Trader | Short-term trades within days. | High | Short-Term |
| Scalper | High-frequency micro-trades. | High | Short-Term |
